...
> ([ARHITEKTURA_M2.md](../archive/ARHITEKTURA_M2.md)); što je izgrađeno opisuje
...
opseg i „gotovo kad“: [ARHITEKTURA_M2.md §13](../archive/ARHITEKTURA_M2.md). Gradi se u tri etape —
...
**Spec M2 je napisan 2026-09-18** ([ARHITEKTURA_M2.md](../archive/ARHITEKTURA_M2.md)) iz brainstorminga s Leonom
