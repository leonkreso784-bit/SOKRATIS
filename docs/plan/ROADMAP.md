...
`records/BACKLOG.md`. Ostali tokovi u tijeku (izvan `main`-a): IO M2/10, M2/11, M2/12 recenzirane
SPOJIVO (M2/11 mjerenje: 3318–3822 ms → 1479,71 ms nad Sokrat Studyjem, git-procesa 92 → 6 — po
pravilu iz plana T18 zato **ulazi**), M2/13 (watcher) u izradi; STORE M2/15, M2/16 SPOJIVO, M2/17
(snimke) u izradi; SUČELJE M2/20, M2/21, M2/22 SPOJIVO, M2/23 (SVG grafovi) na krugu popravka.
