...
**Čeka Leonov OK na spec**; tek potom plan cigli (`superpowers/plans/`), nov SDD ledger i agenti kao
u M1. M0 za M2 je izmjeren (spec §10): jedina instalacija je `npm install` u `apps/desktop`, i ona
čeka OK.
