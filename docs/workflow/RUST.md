...
| `mpsc::Sender`/`Receiver` | M2/13 (`io/src/watch.rs`) | kanal je granica vlasništva između tuđe niti (`notify`) i naše: pošiljatelj gura sirove putanje, primatelj ih preuzima na drugoj strani |
